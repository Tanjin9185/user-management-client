...
const Page = () => {
    ...
    const onSubmit = () => {
        ...
        fetch(`http://localhost:5000/update/${editUserId}`, {
            method: 'PATCH',
    ...
    const handleDelete = (id) => {
        id && fetch(`http://localhost:5000/user/${id}`, {
            method: 'DELETE',
            headers: {
                ...
                <tbody className="text-gray-700">
                    ...
                    <tr>
                        ...
                        <td className="w-1/6 text-left py-3 px-1 flex">
                            ...
                            <span className="hover:text-blue-500" href="mailto:jonsmith@mail.com">
                            </span>
                        ...
                        {/* <td className="w-1/6 text-left py-3 px-1"><a className="hover:text-blue-500" href="mailto:jonsmith@mail.com">delete</a></td> */}
                    </tr>
    ...
    return (
        <>
            {
                isEditClicked && <div><div className="h-screen flex justify-center items-center">
                    <div className="p-2 w-3/4 rounded-lg">
                        <form onSubmit={onSubmit} className="p-3 flex flex-col space-y-5">
                            ...
                            <input type="text" name="lastName" onChange={event => setLastName(event.target.value)} placeholder="Last Name" className="p-2  bg-gray-100" />
                            <input type="text" name="userName" onChange={event => setUserName(event.target.value)} placeholder="Username" className="p-2  bg-gray-100" />

                            <input type="email" name="email" onChange={event => setEmail(event.target.value)} placeholder="email" className="p-2 bg-gray-100" />

                            <input type='password' name="showPassword" onChange={event => setShowPassword(event.target.value)} id="showPassword" onClick={handleShowPassword} placeholder="password" className="p-2 bg-gray-100" />
